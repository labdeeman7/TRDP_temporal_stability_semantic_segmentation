...
crop_size = (32, 32) #** Ensure that the images are around the size of 50x50 when I perform the downscaling. 
train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations'),
    dict(type='Resize', img_scale=(50, 50), ratio_range=(0.5, 2.0)),
