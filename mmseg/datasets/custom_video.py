...
#** need to perform visualizations to ensure every change I made works as intended.
...
class CustomVideoDataset(Dataset):
    ...
    The img/gt_semantic_seg pair of CustomVideoDataset should be of the same
    ...
    Args:
        ...
        sequence_index=1,
        sequence_range=2,
        random_select: using random samples during training.
    ...
    def __init__(self,
                 ...
                 ann_dir=None,
                 seg_map_suffix='.png',
                 sequence_dir=None, #** the sequence directory.
                 sequence_suffix='.png',
                 sequence_num=1,
                 sequence_index=1,
                 sequence_range=2,
        ...
        if self.data_root is not None:
            ...
            if not (self.sequence_dir is None or osp.isabs(self.sequence_dir)): #** what is the sequence director?
        ...
        self.img_infos = self.load_annotations(self.img_dir, self.img_suffix,
                                               ...
                                               self.split
                                               ) #** list of dictionaries. Which have "frames", ann" as a key with a list as the value containing consecutive sequences. 
    ...
    def prepare_train_img(self, idx):
        ...
        return self.pipeline(results) #** pipeline is in init. It passes the results through the a transform
