...
class MemoryModule(nn.Module):
    ...
    def __init__(self,
        ...
        self.matmul_norm = matmul_norm #*okay, what is matmul norm?
    ...
    def forward(self, memory_keys, memory_values, query_key, query_value):
        ...
        """
        #* I am guessing, T is the amount of frames, B batch size, C is number of channels
...
class TMAHead(BaseDecodeHead):
    ...
    def __init__(self, sequence_num, key_channels, value_channels, **kwargs):
        ...
        #corresponds to a single column, we have two columns.
